...
public class AChu_Move : MonoBehaviour
{
    ...
    private void Aoyi()
    {
        Vector3 mousePosition = Haluda_Trans.position;
        mousePosition.z = 0;
        targetDirection = mousePosition - transform.position;
        TargeDistance = Vector2.Distance(transform.position, mousePosition);

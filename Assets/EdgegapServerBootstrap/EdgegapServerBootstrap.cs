...
namespace Edgegap.Bootstrap
{
    public abstract class EdgegapServerBootstrap : MonoBehaviour
    {
        ...
        private static bool ShouldRunBootstrap()
        {
#if UNITY_SERVER
            return true;
#else
            return !string.IsNullOrEmpty(Environment.GetEnvironmentVariable("ARBITRIUM_PORTS_MAPPING"))
                || !string.IsNullOrEmpty(Environment.GetEnvironmentVariable("ARBITRIUM_CONTEXT_PATH"));
#endif
        }

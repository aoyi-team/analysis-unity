...
public class DiShiTianHuoDong : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SpaceCoolImage = GameObject.Find("SpaceHuan").GetComponent<Image>();//���һ���ͼ�꣨��ɫ�ģ�
    }
    void Update()
    {
        StateChange();
    ...
    {
        if (collision.CompareTag("GoldenCoin"))//ʰȡ���Ч��
        {
    ...
    private void CoinPickUp(string CoinTag)//�ӷ��߼�
    {
